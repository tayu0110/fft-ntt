...
pub fn radix_4_inner_complex<T: Float>(
    ...
    // | W^0  W^1  W^2  W^3 | = | W^0  W^1  W^2  W^3 | = | 1  -i  -1   i | => | c0 - Complex::new(-c1.im, c1.re) - c2 + Complex::new(-c3.im, c3.re) |
    // | W^0  W^2  W^4  W^6 |   | W^0  W^2  W^0  W^2 |   | 1  -1   1  -1 |    | c0 - c1 + c2 - c3                                                   |
    // | W^0  W^3  W^6  W^9 |   | W^0  W^3  W^2  W^1 |   | 1   i  -1  -i |    | c0 + Complex::new(-c1.im, c1.re) - c2 - Complex::new(-c3.im, c3.re) |
    (
        Complex::new(c0.re + c1.re + c2.re + c3.re, c0.im + c1.im + c2.im + c3.im),
        Complex::new(c0.re + c1.im - c2.re - c3.im, c0.im - c1.re - c2.im + c3.re),
        Complex::new(c0.re - c1.re + c2.re - c3.re, c0.im - c1.im + c2.im - c3.im),
        Complex::new(c0.re - c1.im - c2.re + c3.im, c0.im + c1.re - c2.im - c3.re),
    )
}
...
pub fn radix_8_inner_complex<T: Float>(
    ...
    let c2pc6 = c2 + c6;
    let c2mc6 = c2 - c6;
    let c2mc6im = Complex::<T>::new(-c2mc6.im, c2mc6.re);
    ...
    let c3pc7 = c3 + c7;
    let c3mc7 = c3 - c7;
    let c1mc5im = Complex::<T>::new(-c1mc5.im, c1mc5.re);
    let c3mc7im = Complex::<T>::new(-c3mc7.im, c3mc7.re);
    ...
    let c1pc5immc3pc7im = Complex::<T>::new(-c1pc5mc3pc7.im, c1pc5mc3pc7.re);
